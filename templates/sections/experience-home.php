<section class="section-experience wf-section">
        ...
        <div class="container-regular">
          <div class="padding-section-medium">
            <div class="margin-bottom margin-huge">
              <h2 class="heading-style-h2 text-font-rbno31 text-weight-black line-height-100 is-small-mobile">
                <span class="text-style-nowrap-all">UPGRADE YOUR</span><br /><span
                  class="experience_h2-line text-color-pink">EXPERIENCE</span>
              </h2>
            </div>
    ...
    <div class="section_background-layer">
      <div class="section_background-flex">
        <div class="screen-container is-section-bg-container">
          <div class="section_background-canvas"></div>
        </div>
      </div>
    </div>
  </div>
